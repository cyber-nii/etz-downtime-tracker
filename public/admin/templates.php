        ...
        if ($action === 'create_template') {
            ...
            $stmt = $pdo->prepare("
                ...
                SET template_name = ?, service_id = ?, component_id = ?,
                    incident_type_id = ?, impact_level = ?, description = ?, root_cause = ?
                WHERE template_id = ?
            ");
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form method="POST" class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="templateIncidentTypeId" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Incident Type <span class="text-gray-400 text-xs">(Optional)</span>
                        </label>
