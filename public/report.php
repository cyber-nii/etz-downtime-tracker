    ...
    if (!empty($errors)) {
        ...
        try {
            ...
            foreach ($service_ids as $s_id) {
                ...
                $ref_prefix = "ETZ-IN#";
                $date_part = date('ymd');
                $random_part = str_pad(mt_rand(1, 999), 3, '0', STR_PAD_LEFT);
                $incident_ref = $ref_prefix . $date_part . $random_part;
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden rounded-xl" style="box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.05), 0 1px 2px 0 rgba(0, 0, 0, 0.03);">
                ...
                <form action="report.php" method="POST" enctype="multipart/form-data" class="px-6 pb-8 pt-6 sm:px-8"
                    ...
                    <div id="templateSelectorContainer" style="display:none;" class="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-xl p-4">
                        <label for="template_select" class="block text-sm font-semibold text-blue-800 dark:text-blue-300 mb-2">
                            <i class="fas fa-magic mr-1.5"></i> Use a Template
                            <span class="text-xs font-normal text-blue-600 dark:text-blue-400 ml-2">(Optional — auto-fills form fields)</span>
                        </label>
                        <select id="template_select"
                            class="block w-full border-blue-200 dark:border-blue-700 rounded-lg shadow-sm py-2.5 px-3.5 text-sm bg-white dark:bg-gray-700 dark:text-white focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <p class="mt-2 text-xs text-blue-600 dark:text-blue-400 flex items-start">
                            ...
                            <span>Select a template to automatically fill in Description, Root Cause, and Impact Level. You can still edit any field before submitting.</span>
                        </p>
                    </div>
