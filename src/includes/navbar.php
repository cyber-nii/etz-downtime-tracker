...
<nav class="bg-white dark:bg-gray-800 sticky top-0 z-50 border-b border-gray-200 dark:border-gray-700 transition-colors duration-200"
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center justify-between w-full">
                ...
                <div class="hidden md:flex space-x-1 absolute left-1/2 transform -translate-x-1/2">
                    ...
                    <a href="<?= url('knowledge_base.php') ?>"
                        class="<?php echo isActive('knowledge_base.php'); ?> px-4 py-2 text-sm font-medium transition-colors duration-150">
                        Knowledge Base
                    </a>
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200"
        ...
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="<?= url('knowledge_base.php') ?>"
                class="<?php echo isMobileActive('knowledge_base.php'); ?> block pl-3 pr-4 py-2.5 border-l-4 text-sm font-medium transition-colors duration-150">
                Knowledge Base
            </a>
            <a href="<?= url('analytics.php') ?>"
